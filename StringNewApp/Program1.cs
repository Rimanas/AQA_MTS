...
namespace StringNewApp
{
    static class Program1
    {
        static void Main(string[] args)
        {
                ...
                // -=================== Append ===================
                StringBuilder sbAppend = new StringBuilder();        //нужно импортировать, когда в первый раз исп-ем - import
                sbAppend.Append("Hello, ");                         // команда Append добавляет в конец существующей строки еще что-то
                ...
                sbAppendLine.Append("Hello, ");                              // как WriteLine
                ...
                */
                ...
                sbInsert.Insert(5, " world");                             // вставляем с 5 индекса и что вставляем

                Console.WriteLine($"Insert : {sbInsert}");                      // Вывод: Hello world!        


                // -=================== Capacity
                StringBuilder sbCapacity = new StringBuilder();    // Capacity  - свойство класса стрингбилдер , которое предоставлет емкость 
            // Capacity - полезно при оптимизации текущей строки, 
            // Capacity - крутится вокруг памяти
            ...
            // Регулярные выражения. используется класс Regex
